...
CPPFLAGS_USED="-DNDEBUG -D_CRT_SECURE_NO_WARNINGS --target=@CHOST@ -nostdlib -fms-runtime-lib=dll -fuse-ld=lld -fno-aligned-allocation"
...
LDFLAGS_USED="--target=@CHOST@ -nostdlib -Wl,-defaultlib:@PREFIX@/lib/clang/@MAJOR_VER@/lib/windows/clang_rt.builtins-x86_64.lib"

...
set "LDFLAGS=-nostdlib -Xclang --dependent-lib=msvcrt -fuse-ld=lld -Wl,-defaultlib:%PREFIX%/lib/clang/@PKG_VERSION@/lib/windows/clang_rt.builtins-x86_64.lib"
set "CFLAGS=%CPPFLAGS_USED%"
set "CXXFLAGS=%CPPFLAGS_USED%"
